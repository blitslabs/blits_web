...
class AddUser extends Component {
    ...
    handleSubmitBtn = (e) => {
        ...
        createUser({ name, email, phone, password, rpassword, accountType: 'USER', pictureData, token })
            .then(data => data.json())
            .then((res) => {
                console.log(res)
                if (res.status === 'OK') {
                        ...
                        <div className="col-md-6 col-xs-12 col-sm-12 grid-margin stretch-card">
                            <div className="card">
                                <div className="card-body">
                                    <div className="card-body">
                                        <h6 className="card-title">Añadir Usuario</h6>
                                        <form className="forms-sample">
                                            ...
                                            <button onClick={this.handleSubmitBtn} className="btn btn-primary mr-2">Añadir Usuario</button>
