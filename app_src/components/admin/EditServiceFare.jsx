...
// API
import { getServiceFarePlan, updateServiceFarePlan } from '../../utils/api'

class EditFarePlan extends Component {
    ...
    componentDidMount() {
        document.title = "Editar Plan de Tarifas"
        const { token } = this.props
        const { serviceFareId } = this.props.match.params

        getServiceFarePlan({ serviceFareId, token })
            .then(data => data.json())
            .then((res) => {
                if (res.status === 'OK') {
                    this.setState({
                        farePlanName: res.payload.farePlanName,
                        startKm: res.payload.startKm,
                        upToKm: res.payload.upToKm,
                        pricePerKm: res.payload.pricePerKm,
                        waitingPricePerMinute: res.payload.waitingPricePerMinute,
                        applyPeakFare: res.payload.applyPeakFare,
                        applyNightFare: res.payload.applyNightFare,
                        nightFareStart: res.payload.nightFareStart,
                        nightFareEnd: res.payload.nightFareEnd,
                        nightFare: res.payload.nightFare,
                        mondayPeakFareStartTime: res.payload.mondayPeakFareStartTime,
                        mondayPeakFareEndTime: res.payload.mondayPeakFareEndTime,
                        mondayPeakFare: res.payload.mondayPeakFare,
                        tuesdayPeakFareStartTime: res.payload.tuesdayPeakFareStartTime,
                        tuesdayPeakFareEndTime: res.payload.tuesdayPeakFareEndTime,
                        tuesdayPeakFare: res.payload.tuesdayPeakFare,
                        wednesdayPeakFareStartTime: res.payload.wednesdayPeakFareStartTime,
                        wednesdayPeakFareEndTime: res.payload.wednesdayPeakFareEndTime,
                        wednesdayPeakFare: res.payload.wednesdayPeakFare,
                        thursdayPeakFareStartTime: res.payload.thursdayPeakFareStartTime,
                        thursdayPeakFareEndTime: res.payload.thursdayPeakFareEndTime,
                        thursdayPeakFare: res.payload.thursdayPeakFare,
                        fridayPeakFareStartTime: res.payload.fridayPeakFareStartTime,
                        fridayPeakFareEndTime: res.payload.fridayPeakFareEndTime,
                        fridayPeakFare: res.payload.fridayPeakFare,
                        saturdayPeakFareStartTime: res.payload.saturdayPeakFareStartTime,
                        saturdayPeakFareEndTime: res.payload.saturdayPeakFareEndTime,
                        saturdayPeakFare: res.payload.saturdayPeakFare,
                        sundayPeakFareStartTime: res.payload.sundayPeakFareStartTime,
                        sundayPeakFareEndTime: res.payload.sundayPeakFareEndTime,
                        sundayPeakFare: res.payload.sundayPeakFare,
                        loading: false
                    })
                }
            })
    ...
    handleSubmitBtn = (e) => {
        ...
        if (applyPeakFare === 'ACTIVE' && (mondayPeakFareStartTime || mondayPeakFareEndTime || mondayPeakFare)) {
        ...
        if (applyPeakFare === 'ACTIVE' && (tuesdayPeakFareStartTime || tuesdayPeakFareEndTime || tuesdayPeakFare)) {
        ...
        if (applyPeakFare === 'ACTIVE' && (wednesdayPeakFareStartTime || wednesdayPeakFareEndTime || wednesdayPeakFare)) {
        ...
        if (applyPeakFare === 'ACTIVE' && (thursdayPeakFareStartTime || thursdayPeakFareEndTime || thursdayPeakFare)) {
        ...
        if (applyPeakFare === 'ACTIVE' && (fridayPeakFareStartTime || fridayPeakFareEndTime || fridayPeakFare)) {
        ...
        if (applyPeakFare === 'ACTIVE' && (saturdayPeakFareStartTime || saturdayPeakFareEndTime || saturdayPeakFare)) {
        ...
        if (applyPeakFare === 'ACTIVE' && (sundayPeakFareStartTime || sundayPeakFareEndTime || sundayPeakFare)) {
                        ...
                        <div className="col-md-6 col-xs-12 col-sm-12 grid-margin stretch-card">
                            <div className="card">
                                <div className="card-body">
                                    <div className="card-body">
                                        <h6 className="card-title">Actualizar Plan Tarifario</h6>
                                        <form className="forms-sample">
                                            ...
                                            <button onClick={this.handleSubmitBtn} className="btn btn-primary mr-2">Actualizar Plan Tarifario</button>
...
export default connect(mapStateToProps)(withRouter(EditFarePlan))
