                ...
                <div className="page-content">
                    <nav className="page-breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">{status === 'ONGOING' ? 'En curso' : status === 'COMPLETED' ? 'Completados' : status === 'CANCELLED' ? 'Cancelados' : status}</li>
                        </ol>
                    </nav>
                        ...
                        <div className="col-md-12 grid-margin stretch-card">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <Pagination url={'/admin/rides'} pages={pages} page={page} />
                                </div>
                            </div>
                        </div>
                    </div>
