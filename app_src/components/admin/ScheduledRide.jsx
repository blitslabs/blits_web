...
class ScheduledRide extends Component {
    ...
    componentDidMount() {
        document.title = "Detalles del Viaje Programado"
                ...
                <div className="page-content">
                    <nav className="page-breadcrumb">
                        <ol className="breadcrumb">
                            <li className="breadcrumb-item"><a href="#">Viaje Programado</a></li>
                    ...
                    <div className="row mt-4">
                                        ...
                                        <div className="table-responsive">
                                            <table className="table table-hover" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Conductor</td>
                                                        <td>{ride.driver == null ? 'Conductor no asignado todavía' : ride.user.name}</td>
                                                    </tr>
                                                    <tr>
                        ...
                        <div className="col-md-8 col-xs-12 col-sm-12 grin-margin ">
                            <div className="card">
                                <div className="card-body">
                                    <h6 className="card-title">Ruta del Viaje Programado</h6>
...
export default connect(mapStateToProps)(ScheduledRide)
